    ...
    */
    ...
    document.getElementById('removeColumnBtn').addEventListener('click', function(event) {
        ...
        if(Object.keys(currentColumns).length > 1) {
            ...
            let newColumnPos = modifyRemovedColumnCardsInModel(cards, selectedColumnPos,
    ...
    let boards =
    {
        'Agenda':
        {
            ...
            cards:[
                ...
                {name: '2 Clean room.', rank: 1, column: 1, isComplete: false, isDeleted: false},
                {name: '3 Clean room.', rank: 2, column: 2, isComplete: false, isDeleted: false},
                {name: '4 Clean room.', rank: 3, column: 0, isComplete: false, isDeleted: false}
            ],
            isDeleted: false,
            columns: [
        ...
        'List of Things':
        {
            ...
            cards:[
                ...
                {name: 'In progresssss.', column: 1, rank: 1, isComplete: false, isDeleted: false},
                {name: 'Done!', column: 2, rank: 2, isComplete: true, isDeleted: false}
            ],
            isDeleted: false,
            columns: [
                {columnName: 'To Do', columnPosition: 0, columnIsDeleted: false},
